...
class BookingControllerTest {
    ...
    @Test
    void book_invalidRequest_returnsBadRequest() throws Exception {
        mockMvc.perform(post("/api/v1.0/flight/booking/1")
                .contentType(MediaType.APPLICATION_JSON)
                .content("{}"))
    ...
    @Test
    void ticket_notFound_returnsNotFound() throws Exception {
    	Mockito.when(bookingService.findByPnr("XYZ")).thenReturn(null);

        mockMvc.perform(get("/api/v1.0/flight/booking/ticket/XYZ"))
